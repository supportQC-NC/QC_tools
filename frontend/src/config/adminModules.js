...
export const PATH_MODULE_MAP = [
  ...
  { path: "/admin/zones-retouchees", key: "inventaire" },
  { path: "/admin/ecarts-zones", key: "inventaire" },
  ...
  { path: "/admin/derniere-facturation", key: "derniere_facturation_admin" },
  ...
  { path: "/admin/frequentation", key: "frequentation_admin" },
