...
// ========== ROUTES CONTRÔLE RÉCEPTION MANUEL (fiches papier) ==========
...
import suiviPreparationRoutes from "./routes/suiviPreparationRoutes.js";
...
import derniereFacturationRoutes from "./routes/derniereFacturationRoutes.js";
...
app.use("/api/suivi-preparations", suiviPreparationRoutes);
// ========== ROUTES ZONES (INVENTAIRE) ==========
...
app.use("/api/derniere-facturation", derniereFacturationRoutes);
