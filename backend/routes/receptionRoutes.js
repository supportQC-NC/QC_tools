...
// Créer / reprendre (ou REJOINDRE) une session de réception partagée
router.post(
  "/",
  protect,
  checkModuleAccess("reception", "write"),
...
// État léger pour le polling (5 s) du contrôle partagé
router.get(
  "/:id/state",
  protect,
  checkModuleAccess("reception", "read"),
...
// Conflits (contrôle partagé) : résolution manuelle d'un doublon
router.post(
  "/:id/conflits/:conflitId/resolve",
  protect,
  checkModuleAccess("reception", "write"),
  resolveConflit,
);
