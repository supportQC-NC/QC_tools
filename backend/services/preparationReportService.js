...
// ===========================================
// COLISAGE — COMPTEURS SEULS
// L'opérateur déclare en fin de préparation COMBIEN de colis, palettes et
// longueurs partent ; ce nombre est rappelé sur le rapport et dans l'email.
// Il n'y a PLUS de feuille de colisage par unité, ni de répartition article
// par article (fonctionnalité retirée le 09/09/2026, décision client).
// ===========================================
...
export const genererSorties = async (preparation, entreprise, operateur) => {
  ...
  // ---- 1bis) Colisage : le NOMBRE déclaré, rien de plus ----
  const refLabel = preparation.type === "reservation" ? "Réservation" : "Proforma";
  const colisage = {
    total: buildColisageTotalLabel({
